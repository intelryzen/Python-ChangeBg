...
img_path = '디지영 프로젝트 영상/bg1.jpg'
# img_path = '디지영 프로젝트 영상/bg2.jpeg' 
...
while cap.isOpened():
    ...
    #histrogram equalization & GaussianBlur
    ...
    #이진 이미지 생성, 마스크 적용 윤곽선 강조, morpoholgy 연산
    ...
    #color thresholding 적용 , 필요한 부분만 남김
    ...
    cv2.imshow('Jumping Person', final_frame)
